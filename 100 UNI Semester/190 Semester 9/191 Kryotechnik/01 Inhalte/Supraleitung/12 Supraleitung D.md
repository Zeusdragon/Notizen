...
Supraleiter in Magneten sind extremen Kräften (Lorentzkraft) ausgesetzt.
* **Problem**: Winzige Bewegungen (Reibungswärme) können zum **Quench** führen (Übergang $sl \to nl$).
* **Lösung**:
    1. [cite_start]**Einbettung in Matrix** (Kupfer/Alu): Nimmt Strom und Wärme im Quench-Fall auf (elektrische & thermische Stabilisierung)[cite: 9969].
    2. [cite_start]**Filamentierung & Twisten**: Reduziert Wirbelströme und Flussspringen (instabiles Eindringen von Fluss)[cite: 10008].
    3. [cite_start]**Imprägnierung**: Vergießen mit Epoxidharz zur mechanischen Fixierung[cite: 10858].

> [!info] Training
> [cite_start]Neue Magnete müssen oft mehrfach "gequencht" werden, bis sich die Wicklung mechanisch "gesetzt" hat und der Nennstrom erreicht wird[cite: 10905].
